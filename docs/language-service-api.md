...
| `TS8035` | `CLASS_MEMBER`              | A class member shape the surface does not take, or a method call the class rules refuse (#86): a getter or setter, an overload, an arrow-function field, a decorator on a method, `this` outside a method or assigned in one, a method called on the class or a static function on a value, or a member the class lacks.                                                                                                                                                                                              |
