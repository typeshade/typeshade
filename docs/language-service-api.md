...
`return` does the arithmetic TypeScript types it `number` the same way: `glow(uv).x` was TS2339,
...
expression body does arithmetic, and whose type is one of the same vectors or matrices. An arrow
