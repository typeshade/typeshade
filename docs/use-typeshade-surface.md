...
**Numbering:** §§9 and 13 are reserved for issue #8's A2 and A3, which are in flight on their
own branches and append here in issue order. The sections below took the next free numbers so
the A-item branches do not all claim §9 and collide on merge.
