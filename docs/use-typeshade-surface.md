...
**Numbering:** §§9, 10, 12 and 13 are reserved for issue #8's A2, A6, A9 and A3, which are
in flight on their own branches and append here in issue order. The sections below took the
