...
| #   | Item                                                                                                                                                                                                                                                                                                                        | Size | Issue | Notes                                                                                                                                                                                |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| X1  | No GPU vocabulary in a compute program: a test scans each domain's example application (simulation, image filter, map layer, histogram, parameter fit) for device, buffer, bind group, pipeline, workgroup and WGSL, and fails on any. The one word that keeps a value on the device is allowed where `explain` asks for it | S    |       | Needs 15 and 16.                                                                                                                                                                     |
