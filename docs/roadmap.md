...
| #   | Item                                                                                                                                                                                                                                  | Size | Issue | Notes                                                                                                                                                                                |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| X1  | No GPU vocabulary in a compute program: a test scans each domain's example application (simulation, image filter, map layer, histogram, parameter fit) for device, buffer, bind group, pipeline, workgroup and WGSL, and fails on any | S    |       | Needs 15 and 16.                                                                                                                                                                     |
...
| X6  | TypeShade code as npm packages: a `.shade.ts` import by bare specifier resolves through `node_modules`, so a library of TypeShade functions is published and imported by name                                                         | M    |       | Today a bare specifier is `TS8099 Only relative imports are supported`. Needs 16. What lets every domain grow its own libraries without the compiler growing one feature per domain. |
...
| 0.5.0   | Items 14 to 17, 16 first, and X1 to X3 and X6.                                                                                                         |
