...
//
// WHAT IT IS. `src/core/spec-conformance/fixtures/coredef.json` is every overload of Tint's
...
const OUT = join(HERE, '..', 'src', 'core', 'spec-conformance', 'fixtures', 'coredef.json');
