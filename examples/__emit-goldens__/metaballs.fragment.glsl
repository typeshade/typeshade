...
void main() {
  ...
  for (uint _v3 = 0u; (float(_v3) < _licm0); _v3 = (_v3 + 1u)) {
    float _gv0 = float(_v3);
    vec2 _v4 = (vec2((_licm1 * _cse1), _licm2) - mix(vec2((sin(((_licm3 * ((_gv0 * 0.13) + 0.5)) + (_gv0 * 2.4))) * 0.55), (cos(((_licm3 * ((_gv0 * 0.11) + 0.4)) + (_gv0 * 1.7))) * 0.42)), _v0, ((1.0 - smoothstep(0.4, 0.6, _gv0)) * _licm4)));
