...
void main() {
  ...
  if ((_cse0 || (u.fp64 < 0.5))) {
    ...
    for (uint _v13 = 0u; (_v13 < 128u); _v13 = (_v13 + 1u)) {
      vec2 _gv2 = df64_mul(_v11, _v11, _fp64_g);
      vec2 _gv3 = df64_mul(_v12, _v12, _fp64_g);
    ...
    _v6 = df64_narrow(df64_add(df64_mul(_v11, _v11, _fp64_g), df64_mul(_v12, _v12, _fp64_g), _fp64_g));
  }
