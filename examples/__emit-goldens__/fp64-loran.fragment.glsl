...
vec4 fs_loran_impl(VsOut vo) {
  ...
  vec2 _cse7 = _cse12.hi;
  vec2 _cse8 = _cse12.lo;
  vec2 _cse9 = vec2(0.0, 0.0);
  ...
  vec2 _cse3 = df64_add(vec2(_cse7.x, _cse8.x), _cse9);
  vec2 _cse4 = df64_add(vec2(_cse7.y, _cse8.y), _cse9);
  vec2 _cse5 = df64_add(vec2(_cse10.x, _cse11.x), _cse9);
  vec2 _cse6 = df64_add(vec2(_cse10.y, _cse11.y), _cse9);
  ...
  vec2 _lc2 = df64_sub(df64_add(vec2(_v6.hi.x, _v6.lo.x), _cse9), _cse3);
  vec2 _lc3 = df64_sub(df64_add(vec2(_v6.hi.y, _v6.lo.y), _cse9), _cse4);
  vec2 _v7 = df64_sqrt(df64_add(df64_mul(_lc2, _lc2), df64_mul(_lc3, _lc3)));
  vec2 _lc4 = df64_sub(df64_add(vec2(_v6.hi.x, _v6.lo.x), _cse9), _cse5);
  vec2 _lc5 = df64_sub(df64_add(vec2(_v6.hi.y, _v6.lo.y), _cse9), _cse6);
  vec2 _v8 = df64_sqrt(df64_add(df64_mul(_lc4, _lc4), df64_mul(_lc5, _lc5)));
  float _v9 = df64_narrow(df64_fract(df64_mul(df64_sub(df64_add(_v7, _cse9), df64_add(_v8, _cse9)), vec2(0.25, 0.0))));
