...
fn fs_newton(vo: VsOut) -> @location(0) vec4<f32> {
  ...
  if ((_cse0 || (u.fp64 < 0.5))) {
    ...
    for (var _v22: u32 = 0u; (_v22 < 48u); _v22 = (_v22 + 1u)) {
      let _v23 = df64_sub(df64_mul(_v20, _v20, _fp64_g), df64_mul(_v21, _v21, _fp64_g), _fp64_g);
      let _v24 = df64_mul(df64_mul(_v20, _v21, _fp64_g), _licm0, _fp64_g);
      ...
      let _v29 = df64_div(_cse3, df64_add(df64_mul(_v27, _v27, _fp64_g), df64_mul(_v28, _v28, _fp64_g), _fp64_g), _fp64_g);
