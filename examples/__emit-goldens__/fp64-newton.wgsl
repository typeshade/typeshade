...
fn fs_newton(vo: VsOut) -> @location(0) vec4<f32> {
  ...
  if ((_cse0 || (u.fp64 < 0.5))) {
    ...
    var _v20: vec2<f32> = df64_add(_cse1, vec2<f32>(_v3, 0.0), _fp64_g);
    var _v21: vec2<f32> = df64_add(_cse2, vec2<f32>(_v4, 0.0), _fp64_g);
    let _cse3 = df64_add(vec2<f32>(1.0, 0.0), _licm0, _fp64_g);
    let _cse4 = vec2<f32>(3.0, 0.0);
    for (var _v22: u32 = 0u; (_v22 < 48u); _v22 = (_v22 + 1u)) {
      let _v23 = df64_sub(df64_sqr(_v20, _fp64_g), df64_sqr(_v21, _fp64_g), _fp64_g);
      let _v24 = (df64_mul(_v20, _v21, _fp64_g) * 2.0);
      let _v25 = df64_sub(df64_sub(df64_mul(_v23, _v20, _fp64_g), df64_mul(_v24, _v21, _fp64_g), _fp64_g), _cse3, _fp64_g);
      let _v26 = df64_add(df64_mul(_v23, _v21, _fp64_g), df64_mul(_v24, _v20, _fp64_g), _fp64_g);
      let _v27 = df64_mul(_v23, _cse4, _fp64_g);
      let _v28 = df64_mul(_v24, _cse4, _fp64_g);
      let _v29 = df64_div(_cse3, df64_add(df64_sqr(_v27, _fp64_g), df64_sqr(_v28, _fp64_g), _fp64_g), _fp64_g);
      let _v30 = df64_mul(df64_add(df64_mul(_v25, _v27, _fp64_g), df64_mul(_v26, _v28, _fp64_g), _fp64_g), _v29, _fp64_g);
      let _v31 = df64_mul(df64_sub(df64_mul(_v26, _v27, _fp64_g), df64_mul(_v25, _v28, _fp64_g), _fp64_g), _v29, _fp64_g);
      _v20 = df64_sub(df64_add(_v20, _licm0, _fp64_g), df64_add(_v30, _licm0, _fp64_g), _fp64_g);
      _v21 = df64_sub(df64_add(_v21, _licm0, _fp64_g), df64_add(_v31, _licm0, _fp64_g), _fp64_g);
      if ((df64_narrow(df64_add(df64_sqr(_v30, _fp64_g), df64_sqr(_v31, _fp64_g), _fp64_g)) > 1e-14)) {
        _v7 = (_v7 + 1.0);
      }
    }
