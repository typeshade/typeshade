...
fn fs_newton(vo: VsOut) -> @location(0) vec4<f32> {
  ...
  if ((_cse0 || (u.fp64 < 0.5))) {
    ...
    let _cse3 = df64_add(vec2<f32>(1.0, 0.0), _licm1, _fp64_g);
    let _cse4 = vec2<f32>(3.0, 0.0);
    for (var j_1: u32 = 0u; (j_1 < 48u); j_1 = (j_1 + 1u)) {
      let z2x_1 = df64_sub(df64_mul(zx_1, zx_1, _fp64_g), df64_mul(zy_1, zy_1, _fp64_g), _fp64_g);
      let z2y_1 = df64_mul(df64_mul(zx_1, zy_1, _fp64_g), _licm0, _fp64_g);
      ...
      let inv_1 = df64_div(_cse3, df64_add(df64_mul(gx_1, gx_1, _fp64_g), df64_mul(gy_1, gy_1, _fp64_g), _fp64_g), _fp64_g);
