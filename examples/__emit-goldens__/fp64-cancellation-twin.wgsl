...
fn fs_cancel(vo: VsOut) -> @location(0) vec4<f32> {
  ...
  let xd = df64_add(_cse1, vec2<f32>(d, 0.0));
  let x2 = df64_mul(xd, xd);
  let x3 = df64_mul(x2, xd);
  let x4 = df64_mul(x2, x2);
  let x5 = df64_mul(x4, xd);
  let x6 = df64_mul(x3, x3);
  let x7 = df64_mul(x6, xd);
  ...
  let p64 = df64_narrow(df64_sub(df64_add(df64_sub(df64_add(df64_sub(df64_add(df64_sub(df64_add(x7, _cse2), df64_mul(x6, _cse3)), df64_mul(x5, _cse4)), df64_mul(x4, _cse5)), df64_mul(x3, _cse5)), df64_mul(x2, _cse4)), df64_mul(xd, _cse3)), df64_add(_cse1, _cse2)));
  let xf = (1.0 + d);
  let f2 = (xf * xf);
  let f3 = (f2 * xf);
  let f4 = (f2 * f2);
