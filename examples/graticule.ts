...
import {
  ...
  abs, fract, smoothstep, max, mix, clamp, fwidth, f32,
  location, builtin,
...
export const graticule: ShaderExample = {
  id: 'graticule',
  title: 'Graticule',
  blurb: 'The lon/lat grid every map draws — anti-aliased with screen-constant width via fwidth, gold equator, slowly spinning over time. Adjust the spacing in degrees.',
