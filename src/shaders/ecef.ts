...
const lonlatToEcef = fn('lonlat_to_ecef', { lon_rad: f32T, lat_rad: f32T, height: f32T }, vec3fT, (p, _b) => {
...
const ecefRtcReconstruct = fn('ecef_rtc_reconstruct', { pos_h: vec3fT, pos_l: vec3fT }, vec3fT, (p, _b) => p.pos_h.add(p.pos_l))
