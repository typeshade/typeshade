...
`
    ...
    expect(rows).toEqual(['4:3 typescript TS2588', '4:3 typeshade TS8005', '4:7 typescript TS2552'])
...
`
  ...
  it('json: the report as data, versioned', () => {
    const parsed = JSON.parse(formatCheckReport(report, 'json', sources)) as Record<string, unknown>
