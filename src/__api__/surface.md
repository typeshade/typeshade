...
src/compiler/ts/source-file.ts#CompileTsSourceOptions  interface  { checkReservedNames?: boolean; emit?: boolean; fileName?: string; requireDirective?: boolean; sourceFile?: SourceFile }
...
src/core/backend.ts#CapProfile  type  { compute?: <no-declaration>; f16?: <no-declaration>; float32Blend?: <no-declaration>; float32Filterable?: <no-declaration>; floatRenderTarget?: <no-declaration>; msaaTextureLoad?: <no-declaration>; multiview?: <no-declaration>; storageBuffer?: <no-declaration>; storageTexture?: <no-declaration>; subgroups?: <no-declaration>; texture1d?: <no-declaration>; textureCubeArray?: <no-declaration>; textureGather?: <no-declaration> }
...
src/core/ir/nodes.ts#ALL_CAPABILITIES  const  readonly ["storageBuffer", "compute", "msaaTextureLoad", "storageTexture", "texture1d", "textureCubeArray", "textureGather", "f16", "subgroups", "floatRenderTarget", "float32Blend", "float32Filterable", "multiview"]
...
src/core/ir/nodes.ts#Capability  type  "compute" | "f16" | "float32Blend" | "float32Filterable" | "floatRenderTarget" | "msaaTextureLoad" | "multiview" | "storageBuffer" | "storageTexture" | "subgroups" | "texture1d" | "textureCubeArray" | "textureGather"
...
src/core/ir/nodes.ts#DeclarableCapability  type  "f16" | "float32Blend" | "float32Filterable" | "floatRenderTarget" | "multiview" | "subgroups"
...
src/core/ir/types.ts#StorageTextureFormat  type  "r32float" | "r32sint" | "r32uint" | "rg32float" | "rg32sint" | "rg32uint" | "rgba16float" | "rgba16sint" | "rgba16uint" | "rgba32float" | "rgba32sint" | "rgba32uint" | "rgba8sint" | "rgba8snorm" | "rgba8uint" | "rgba8unorm"
...
src/core/sot.ts#FixedTypeBuiltinName  type  "frag_depth" | "front_facing" | "global_invocation_id" | "instance_index" | "local_invocation_id" | "local_invocation_index" | "num_workgroups" | "position" | "sample_index" | "sample_mask" | "subgroup_invocation_id" | "subgroup_size" | "vertex_index" | "workgroup_id"
...
src/core/sot.ts#WgslBuiltinName  type  "clip_distances" | "frag_depth" | "front_facing" | "global_invocation_id" | "instance_index" | "local_invocation_id" | "local_invocation_index" | "num_workgroups" | "position" | "sample_index" | "sample_mask" | "subgroup_invocation_id" | "subgroup_size" | "vertex_index" | "workgroup_id"
