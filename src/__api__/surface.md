...
src/core/ir/nodes.ts#Capability  type  "bgra8unormStorage" | "compute" | "f16" | "float32Blend" | "float32Filterable" | "floatRenderTarget" | "msaaTextureLoad" | "multiview" | "packed4x8Dot" | "storageBuffer" | "storageTexture" | "subgroups" | "texture1d" | "textureCubeArray" | "textureGather"
...
src/core/reflect.ts#Reflection  interface  { bindGroups: readonly BindGroup[]; entries: readonly EntryInfo[]; overrides: readonly OverrideInfo[]; requiredFeatures: readonly Capability[]; requiredLanguageFeatures: readonly string[]; requires: readonly ExternRequirement[]; storage: readonly StructLayout[]; uniforms: readonly StructLayout[]; vertex?: VertexLayout }
