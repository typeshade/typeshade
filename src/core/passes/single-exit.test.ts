...
describe('checkSingleExit — MISRA-style single point of exit', () => {
  ...
  it('flags multiple returns in branches', () => {
    const f = fn('bad2', { x: f32T }, f32T, ({ x }, _b) => {
