      ...
      funcs: [
        {
          ...
          body: [
            { s: 'if', arms: [{ cond: litBool(false), body: [ret(1)] }], elseBody: [ret(2)] },
          ] as Stmt[],
        },
      ],
    })
      ...
      funcs: [
        {
          ...
          allowEarlyReturn: true,
          body: [
            { s: 'if', arms: [{ cond: litBool(true), body: [ret(7)] }], elseBody: [ret(9)] },
          ] as Stmt[],
        },
      ],
    })
          ...
          body: [
            {
              ...
              arms: [
                {
                  cond: { op: 'compare', type: boolT, cop: '>', a: lit(0), b: lit(1) },
                  body: [ret(1)],
                },
              ],
