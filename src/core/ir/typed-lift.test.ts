...
describe('shader-dsl IR — typed arithmetic lift (#6)', () => {
  it('u32-LHS .add(1) emits an integer literal (1u), not 1.0', () => {
    const f = fn('addU', { a: u32T }, u32T, (p, b) => { b.ret(p.a.add(1)) })
